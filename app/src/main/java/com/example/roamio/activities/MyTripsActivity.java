...
import com.example.roamio.activities.TripActivity;
import com.example.roamio.activities.ItineraryActivity;
...
public class MyTripsActivity extends AppCompatActivity {
    ...
    private View buildTripCard(String destination, String tripName,
        ...
        tvEmoji.setBackgroundResource(R.drawable.bg_logo_circle);
